...
public:
  // default SkipList has Depth of 1, just one doubly-linked list RS
  ...
  // Add to list, assume no duplicates MS
  void add(int val);

  // Add to list, assume no duplicates MS
  void add(const vector<int> &values);

  // return true if successfully removed RS
  bool remove(int val);

  // return true if found in SkipList RS
